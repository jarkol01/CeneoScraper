...
## Etapy pracy nad projektem stukturalnym
...
7. Analiza opinii o wybranym produkcie
    1. wczytanie wszystkich opinii o wskazanum produkcie do obiektu DataFrame
    2. wyliczenie podstawowych statystyk o produkcie
        1. liczba wy=szystkich opinii o produkcie
    ...
    3. przygotowanie wykresów na podstawie zawartości opinii
        ...
        2. histogram częstości występowanie poszczególnych ocen (liczby gwiazdek)